...
from vim_adaptor.util.mongoengine_custom_json import makeHttpDatetime
...
class TimestampsDocument(TimestampsMixin, Document):
    """
    Abstract `Document` subclass that defines and manages a `createdAt` and an
    `updatedAt` field
    """
...
class UuidMixin:
    """
    Document mixin that defines a primary-key `id` field containing an auto-generated
    UUID
    """
...
class UuidDocument(UuidMixin, Document):
    """
    Abstract `Document` subclass that defines a primary-key `id` field containing an
    auto-generated UUID
    """
